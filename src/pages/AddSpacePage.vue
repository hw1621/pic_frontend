<template>
  <div id="addSpacePage">
    ...
    <a-form name="spaceForm" layout="vertical" :model="spaceForm" @finish="handleSubmit">
      ...
      <a-form-item name="spaceLevel" label="Space level">
        <a-select
          ...
          placeholder="Please choose spacec level"
    ...
    <!-- 空间级别介绍 -->
    <a-card title="Space Level Description">
      <a-typography-paragraph>
        * Currently only support common level, if need upgrade, please contact
        <a href="https://codefather.cn" target="_blank">hw1621</a>
      </a-typography-paragraph>
